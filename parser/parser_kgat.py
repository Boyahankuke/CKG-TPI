...
def parse_kgat_args():
    ...
    parser.add_argument('--data_name', nargs='?', default='KG_data',
                        help='Choose a dataset from {KG_data}')
    ...
    parser.add_argument('--conv_dim_list', nargs='?', default='[256, 128, 64]',
    ...
    parser.add_argument('--stopping_steps', type=int, default=1000,
    ...
    parser.add_argument('--Ks', nargs='?', default='[100, 200, 500]',
                        help='Calculate metric@K when evaluating.')

    parser.add_argument('--dataset_name', type=str, default="VDJdb", help='dataset name.')
    parser.add_argument('--split_name', type=str, default="Strict", help='train-test split.')
    parser.add_argument('--fold', type=int, default=0, help='train-test fold.')
